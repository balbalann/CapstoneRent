...
<link rel="apple-touch-icon-precomposed" sizes="144x144" href="assets/images/favicon-icon/logo-no-background.png">
<link rel="apple-touch-icon-precomposed" sizes="114x114" href="assets/images/favicon-icon/logo-no-background.png">
<link rel="apple-touch-icon-precomposed" sizes="72x72" href="assets/images/favicon-icon/logo-no-background.png">
<link rel="apple-touch-icon-precomposed" href="assets/images/favicon-icon/logo-no-background.png">
<link rel="shortcut icon" href="assets/images/favicon-icon/logo-no-background.png">
    ...
    <div class="listing_detail_head row">
      ...
      <div class="col-md-3">
        <div class="price_info">
          <p>IDR <?php echo htmlentities($result->PricePerDay);?> </p>Per Day
        ...
        <div class="col-md-3 grid_listing">
          <div class="product-listing-m gray-bg">
            ...
            <div class="product-listing-content">
              ...
              <p class="list-price">IDR <?php echo htmlentities($result->PricePerDay);?></p>
